...
#include "DesGameplayAbility_Attack.generated.h"
...
UCLASS()
class DESCENSUS_API UDesGameplayAbility_Attack : public UDesGameplayAbilityPrimaryBase
{
	GENERATED_BODY()
